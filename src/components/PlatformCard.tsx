      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex justify-between items-baseline">
            ...
            <span className="text-sm font-bold text-brand-muted">+{formatNumber(bjpGrowth)} since May 16</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex justify-between items-baseline">
            ...
            <span className="text-sm font-bold text-brand-muted">+{formatNumber(cjpGrowth)} since May 16</span>
          </div>
        </div>
